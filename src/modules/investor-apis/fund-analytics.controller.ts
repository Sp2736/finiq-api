...
export class FundAnalyticsController {
    ...
    async getFundReturns(@Param('amfiCode') amfiCode: string) {
        ...
        return ResponseFormatter.success(result, 'Fund returns retrieved successfully');
    }
    ...
    async getFundMonthlyReturns(@Param('amfiCode') amfiCode: string) {
        ...
        return ResponseFormatter.success(result, 'Fund monthly returns retrieved successfully');
    }
    ...
    async getFundComposition(@Param('amfiCode') amfiCode: string) {
        ...
        return ResponseFormatter.success(result, 'Fund composition retrieved successfully');
    }
    ...
    async getFundStylebox(@Param('amfiCode') amfiCode: string) {
        ...
        return ResponseFormatter.success(result, 'Fund stylebox retrieved successfully');
    }
    ...
    async getFundRiskStats(@Param('amfiCode') amfiCode: string) {
        ...
        return ResponseFormatter.success(result, 'Fund risk statistics retrieved successfully');
    }
    ...
    async getFundSectorAllocation(@Param('amfiCode') amfiCode: string) {
        ...
        return ResponseFormatter.success(result, 'Fund sector allocation retrieved successfully');
    }
}
