...
export class AuthenticationRepository {
    ...
    async createOtp(phoneNumber: string, otpCode: string, expiresAt: Date, scope: 'USER' | 'INVESTOR' = 'USER'): Promise<OtpLog> {
    ...
    async findLatestOtp(phoneNumber: string, scope: 'USER' | 'INVESTOR' = 'USER'): Promise<OtpLog | null> {
